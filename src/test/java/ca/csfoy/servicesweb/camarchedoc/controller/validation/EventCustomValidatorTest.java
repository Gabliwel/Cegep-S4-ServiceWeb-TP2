...
public class EventCustomValidatorTest {
    ...
    private final TrailDto ANY_TRAIL_DTO = new TrailDto("3", "Promenade des pommes", "Promenade en apprenant comment faire un backflip.", "Toronto", TrailDifficulty.BEGINNER,
