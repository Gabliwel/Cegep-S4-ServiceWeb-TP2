...
INSERT INTO TRAIL(ID, CITY, DESCRIPTION, DIFFICULTY, LAST_MAINTENANCE_DATE, NAME, OPENING_DATE, STATUS, AVERAGE_SCORE)
VALUES('2', 'montreal', 'deuxieme trail', 1, parseDatetime('2021-12-30', 'yyyy-MM-dd'), 'bonsoir2', parseDatetime('1998-12-31', 'yyyy-MM-dd'), 0, 2.0);
...
INSERT INTO USER(ID, FIRSTNAME, LASTNAME, PREFERRED_DIFFICULTY)
VALUES('1', 'Bob', 'JSP', 0);

INSERT INTO USER(ID, FIRSTNAME, LASTNAME, PREFERRED_DIFFICULTY)
VALUES('2', 'Bob2', 'JSP encore', 1);
