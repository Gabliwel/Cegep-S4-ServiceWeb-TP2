...
public interface TrailResource {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200",
            description = "Sentier trouvé",
            content = { @Content(mediaType = "application/json", schema = @Schema(implementation = TrailDto.class)) }), @ApiResponse(responseCode = "400",
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "201",
            description = "Sentier créé",
            content = { @Content(mediaType = "application/json", schema = @Schema(implementation = TrailDto.class)) }), @ApiResponse(responseCode = "400",
                    description = "Sentier invalide",
                    content = @Content), @ApiResponse(responseCode = "415", description = "Sentier déjà existant", content = @Content) })
    @PostMapping
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Sentier supprimé", content = @Content), @ApiResponse(responseCode = "400",
            description = "Identifiant invalide",
            content = @Content), @ApiResponse(responseCode = "404", description = "Sentier introuvable", content = @Content) })
