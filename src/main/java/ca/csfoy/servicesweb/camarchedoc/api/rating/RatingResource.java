...
public interface RatingResource {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200",
            description = "appreciation trouvé",
            content = { @Content(mediaType = "application/json", schema = @Schema(implementation = RatingDto.class)) }), @ApiResponse(responseCode = "400",
                    ...
                    content = @Content), @ApiResponse(responseCode = "404", description = "appreciation introuvable", content = @Content) })
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200",
            description = "appreciations trouvés",
